...
class EgoTaskQA(TextVideoDataset):
    def _load_metadata(self, args):
        metadata_dir = '/userhome/data/Data/qa/' + args.dataset_split_type
        split_files = {
...
#     tokenizer = transformers.AutoTokenizer.from_pretrained(config['arch']['args']['text_params']['model'])
    tokenizer = transformers.AutoTokenizer.from_pretrained("/userhome/pretrain_model/roberta-base", local_files_only=True)
